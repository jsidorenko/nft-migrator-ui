...
export const CssFontRegularXS = css`
  font-family: 'Inter', sans-serif;
  font-size: 12px;
  line-height: 18px;
  font-weight: 400;
...
export const CssButtonMainLightStyles = css<CommonStyleProps>`
  ${CssButtonMainStyles}
  color: ${({ theme }) => theme.accentsPink};
  background-color: ${({ theme }) => theme.appliedLightPinkBackground};
  border: 2px solid ${({ theme }) => theme.appliedLightPinkBackground};
